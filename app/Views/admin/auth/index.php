      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <h4 class="text-dark font-weight-normal">Selamat Datang <span class="font-weight-bold">MyWebs</span></h4>
            <p class="text-muted">Silahkan Masukkan Username dan Password</p>
            <form method="POST" action="/auth/auths" class="needs-validation" novalidate="">
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; MyWebs. Made with 💙 by Stesla
            </div>
          </div>
        </div>
